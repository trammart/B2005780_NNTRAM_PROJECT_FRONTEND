                            ...
                            <div class="row pb-2">
                                <div class="col-md-7">
                                    <p style="font-family: VL BoosterNextFYThin; font-weight: bold;">
                                        Contains milk, wheat, soya and FD&C Yellow (Tartrazine).

                                        Water, chocolate sandwich cookies (wheat flour, cocoa, soya lecithin), glucose,
                                        refined sugar, palm oil, Hershey's white vanilla chips (refined sugar, palm oil,
                                        skimmed milk powder, corn starch, salt and soya lecithin), skimmed milk powder,
                                        buttermilk powder, whey powder, modified starch, food stabilizers and emulsifiers
                                        (distilled mono
                                        and diglycerides), artificial food flavors and
                                        artificial food colors.</p>
                                </div>
...
export default defineComponent({
    ...
    mounted() {
        document.title = 'Chi tiết sản phẩm - iCream';
    },
    setup(props) {
